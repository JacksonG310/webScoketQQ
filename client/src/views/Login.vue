<template>
  <div id="login">
    ...
    >
      ...
      <template slot="right"> 注册 </template>
    </top-bar>
    <div class="main">
      <div class="logo">
      ...
      <div class="form-field">
        <div class="title">
          <h3>登录</h3>
          <div class="welcome">欢迎加入信科QQ2022</div>
        </div>
        <van-form ref="loginForm">
          <van-field
            name="username"
            :rules="loginFormRules.data"
            v-model="loginForm.data"
            label="用户名/邮箱"
            placeholder="用户名/邮箱"
          ></van-field>
          <van-field
      ...
      this.$refs.loginForm
        ...
        .then(async () => {
          ...
          if (res.code === 20000) {
            ...
            window.localStorage.setItem(`profile`, res.data.profile);
