<template>
    <div id="apply-item">
      <div class="cell-left">
        <van-badge :content="99" max="99">
          <img class="friend-profile" :src="require('../../assets/images/list-item/apply.png')"/>
        </van-badge>
      </div>
      <div class="cell-right">
          <div class="top">
            <span class="friend-name">好友申请</span>
          </div>
        <div class="bottom">
          <p class="last-news">快来看看新朋友</p>
        </div>
      </div>
    </div>
</template>
